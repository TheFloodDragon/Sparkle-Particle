...
def main():
    ...
    ParticleCompiler.save_animation(
        ...
        f"{output_dir}/anim_cube_breathing", func_path="p:anim_cube_breathing", loop=True,
    )
    ...
    ParticleCompiler.save_animation(
        ...
        f"{output_dir}/anim_spinning_icosa", func_path="p:anim_spinning_icosa", loop=True,
    )
    ...
    ParticleCompiler.save_animation(
        ...
        f"{output_dir}/anim_poly_showcase", func_path="p:anim_poly_showcase", loop=True,
    )
    ...
    ParticleCompiler.save_animation(
        ...
        f"{output_dir}/anim_spinning_knot", func_path="p:anim_spinning_knot", loop=True,
    )
    ...
    ParticleCompiler.save_animation(
        ...
        f"{output_dir}/anim_icosa_implode", func_path="p:anim_icosa_implode",
    )
    ...
    ParticleCompiler.save_animation(
        ...
        f"{output_dir}/anim_solid_cube_spin", func_path="p:anim_solid_cube_spin", loop=True,
    )
    ...
    ParticleCompiler.save_animation(
        ...
        f"{output_dir}/anim_dna_decorated", func_path="p:anim_dna_decorated", loop=True,
    )
