...
用Python代码生成 Minecraft Java Edition 的 `.mcfunction` 粒子命令文件。

核心库 **sparkle** 提供了图形构建、 空间变换、 运动控制和动画编排的Python API，

由此借助Python代码的编写，可直接生成放入数据包使用的 `.mcfunction` 文件，

或者支持的另一种格式: **SPS**。

目标版本：**Java Edition 1.20+**

*注： 有些代码为AI生成，但都经过我的审查、修改。*
